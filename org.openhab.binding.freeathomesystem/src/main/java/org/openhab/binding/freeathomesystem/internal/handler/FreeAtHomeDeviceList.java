...
/**
 * The {@link FreeAtHomeDeviceList} is responsible for device lists from free@home bridge.
 *
 * @author Andras Uhrin - Initial contribution
 *
 */

public class FreeAtHomeDeviceList {

    private final Logger logger = LoggerFactory.getLogger(FreeAtHomeDeviceList.class);
    ...
    public FreeAtHomeDeviceList(HttpClient client, String forIpAddress, String forSysAP) {
        httpClient = client;
